	...
	function createThumbnail(md5){ //create thumbnail preview of media object	
		...
		switch(media_type){
			case "sprite":
				...
				html+='<div class="arrows"><a id="left" class="carousel-control left arrow-left off" href="#" data-slide="prev">â€¹</a>\<a id="right" class="carousel-control right arrow-right off" href="#" data-slide="next">â€º</a></div>';
